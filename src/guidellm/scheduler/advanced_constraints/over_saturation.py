...
class OverSaturationConstraint(CallableConstraint):  # type: ignore[misc]
    """
...
class OverSaturationConstraintInitializer(
    _OverSaturationBase,
    CallableConstraintInitializer,  # type: ignore[misc]
):
